...
class WP_Query {
	...
	protected function get_search_stopwords() {
		...
		$words = explode( ',', 'about,an,are,as,at,be,by,com,for,from,how,in,is,it,of,on,or,that,the,this,to,was,what,when,where,who,will,with,www' );
		$stopwords = array();
	...
	public function get_posts() {
		...
		if ( ! empty( $q['s'] ) ) {
			$search_orderby = '';
			if ( ! empty( $q['search_orderby_title'] ) && empty( $q['orderby'] ) || ( isset( $q['orderby'] ) && 'relevance' === $q['orderby'] ) )
