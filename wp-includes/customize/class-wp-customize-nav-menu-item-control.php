			...
			<div class="menu-item-handle">
				...
				<span class="item-controls">
					<button type="button" class="button-link item-edit" aria-expanded="false"><span class="screen-reader-text"><?php
						printf( 'Edit menu item: %1$s (%2$s)', '{{ data.title || wp.customize.Menus.data.l10n.untitled }}', '{{ data.item_type_label }}' );
					?></span><span class="toggle-indicator" aria-hidden="true"></span></button>
					<button type="button" class="button-link item-delete submitdelete deletion"><span class="screen-reader-text"><?php
						printf( 'Remove Menu Item: %1$s (%2$s)', '{{ data.title || wp.customize.Menus.data.l10n.untitled }}', '{{ data.item_type_label }}' );
					?></span></button>
				</span>
			</div>
		</div>
		...
		<# } #>
			...
			<div class="menu-item-actions description-thin submitbox">
				...
				<p class="link-to-original">
					<?php printf( 'Original: %s', '<a class="original-link" href="{{ data.url }}">{{ data.original_title }}</a>' ); ?>
				</p>
				<# } #>
