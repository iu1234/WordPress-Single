...
get_current_screen()->add_help_tab( array(
	'id'      => 'press-this',
	'title'   => 'Press This',
	'content' => '<p>Press This is a bookmarklet that makes it easy to blog about something you come across on the web. You can use it to just grab a link, or to post an excerpt. Press This will even allow you to choose from images included on the page and use them in your post. Just drag the Press This link on this screen to your bookmarks bar in your browser, and you&#8217;ll be on your way to easier content creation. Clicking on it while on another website opens a popup window with all these options.</p>',
) );
get_current_screen()->add_help_tab( array(
	'id'      => 'converter',
...
<div class="card pressthis">
	<h2>Press This</h2>
	<p>Press This is a little tool that lets you grab bits of the web and create new posts with ease.</p>
	...
	<form>
		...
		<h4>Direct link (best for mobile)</h4>
		<p>Follow the link to open Press This. Then add it to your device&#8217;s bookmarks or home screen.</p>
