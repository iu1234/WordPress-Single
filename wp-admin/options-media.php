...
$media_options_help = '<p>You can set maximum sizes for images inserted into your written content; you can also insert an image as Full Size.</p>';

if ( get_option('upload_url_path') || ( get_option('upload_path') != 'wp-content/uploads' && get_option('upload_path') ) ) {
	$media_options_help .= '<p>Uploading Files allows you to choose the folder and path for storing your uploaded files.</p>';
}

$media_options_help .= '<p>You must click the Save Changes button at the bottom of the screen for new settings to take effect.</p>';
...
?>
<tr>
<th scope="row"><label for="upload_path">Store uploads in this folder</label></th>
<td><input name="upload_path" type="text" id="upload_path" value="<?php echo esc_attr(get_option('upload_path')); ?>" class="regular-text code" />
<p class="description"><?php
	printf( 'Default is %s', '<code>wp-content/uploads</code>' );
?></p>
</td>
</tr>

<tr>
<th scope="row"><label for="upload_url_path">Full URL path to files</label></th>
<td><input name="upload_url_path" type="text" id="upload_url_path" value="<?php echo esc_attr( get_option('upload_url_path')); ?>" class="regular-text code" />
<p class="description">Configuring this is optional. By default, it should be blank.</p>
</td>
</tr>
<?php endif; ?>
<tr>
