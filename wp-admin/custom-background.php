...
class Custom_Background {
	...
	public function init() {
		$page = add_theme_page( 'Background', 'Background', 'edit_theme_options', 'custom-background', array( $this, 'admin_page' ) );
		if ( ! $page ) {
			return;
		}
...
<p><?php printf( 'Background updated. <a href="%s">Visit your site</a> to see how it looks.', home_url( '/' ) ); ?></p>
</div>
<?php } ?>
...
<?php submit_button( 'Remove Background Image', 'button', 'remove-background', false ); ?><br/>
...
<?php submit_button( 'Restore Original Image', 'button', 'reset-background', false ); ?><br/>
...
<td><form enctype="multipart/form-data" id="upload-form" class="wp-upload-form" method="post">
	...
	<p>
		...
		<button id="choose-from-library-link" class="button"
			...
			data-update="<?php esc_attr_e( 'Set as background' ); ?>">Choose Image</button>
	</p>
	</form>
</td>
</tr>
...
<td><fieldset><legend class="screen-reader-text"><span>Background Repeat</span></legend>
