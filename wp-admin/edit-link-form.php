...
if ( ! empty($link_id) ) {
	$heading = sprintf( '<a href="%s">Links</a> / Edit Link', 'link-manager.php' );
	$submit_text = 'Update Link';
	$form_name = 'editlink';
	$nonce_action = 'update-bookmark_' . $link_id;
} else {
	$heading = sprintf( '<a href="%s">Links</a> / Add New Link', 'link-manager.php' );
	$submit_text = 'Add Link';
	$form_name = 'addlink';
...
add_meta_box('linksubmitdiv', 'Save', 'link_submit_meta_box', null, 'side', 'core');
add_meta_box('linkcategorydiv', 'Categories', 'link_categories_meta_box', null, 'normal', 'core');
add_meta_box('linktargetdiv', 'Target', 'link_target_meta_box', null, 'normal', 'core');
add_meta_box('linkxfndiv', 'Link Relationship (XFN)', 'link_xfn_meta_box', null, 'normal', 'core');
add_meta_box('linkadvanceddiv', 'Advanced', 'link_advanced_meta_box', null, 'normal', 'core');
...
<div class="wrap">
<h1><?php echo esc_html( $title ); ?>  <a href="link-add.php" class="page-title-action">Add New</a></h1>

<?php if ( isset( $_GET['added'] ) ) : ?>
<div id="message" class="updated notice is-dismissible"><p>Link added.</p></div>
<?php endif; ?>
...
<h2><label for="link_name">Name</label></h2>
<div class="inside">
...
<h2><label for="link_url">Web Address</label></h2>
<div class="inside">
...
<div class="inside">
	...
	<p>This will be shown when someone hovers over the link in the blogroll, or optionally below the link.</p>
</div>
</div>
</div>
